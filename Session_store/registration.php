...
<body>
    <h2 class="text-center pt-5 text-3xl font-bold tracking-widest">Registration</h2>
 <div class="form pt-5 flex  justify-center  ">
 <div class="box shadow-sm border border-current">
<form class="max-w-md mx-auto pt-6" method="post">
 <div class="relative z-0 w-full mb-7 group">
  ...
  <div class="relative z-0 w-full mb-7 group">
      <input type="password" name="confirmpassword" id="confirmpassword" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
     ...
     <div class="text-center relative bottom-1.5">
  <button type="submit" name="submit" class="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
  </div>
</form>

    <div class="text-center tracking-wide text-xl ">
